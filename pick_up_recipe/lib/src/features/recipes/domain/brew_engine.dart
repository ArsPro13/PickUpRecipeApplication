...
//
// ⚠️ НЕ ПОДКЛЮЧЁН К ПРИЛОЖЕНИЮ. Ни один существующий файл его не импортирует,
// текущий экран заваривания работает как работал. Подключать — за фича-флагом,
// после обсуждения дизайна (design/variants/README.md).
//
// ⚠️ КОД НЕ КОМПИЛИРОВАЛСЯ. На машине, где он написан, нет ни Flutter, ни Dart
// SDK, поэтому `dart analyze` и `dart test` прогнать не удалось. Проверять
// обязательно (вопрос Q10 в docs/night/QUESTIONS.md).
//
// ── Зачем он вообще ─────────────────────────────────────────────────────────
//
