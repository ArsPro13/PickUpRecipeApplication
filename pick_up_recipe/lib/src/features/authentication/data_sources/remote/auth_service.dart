...
class AuthService {
  ...
  ///
  /// Отдельной ручки повтора у бэкенда пока нет — письмо шлёт та же
  /// `/mail/send_verify_email`, на которой стоит ограничение в минуту. Когда
  /// ручка появится, менять здесь придётся один адрес.
