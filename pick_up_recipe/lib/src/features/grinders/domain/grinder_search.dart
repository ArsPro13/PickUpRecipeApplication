...
/// Слово «модель» в нужном числе: 1 модель, 2 модели, 50 моделей.
///
/// Число берётся из справочника, а не пишется словом, поэтому и форма слова
/// не может быть записана заранее.
String grinderCountWord(int count) {
