...
void main() {
  ...
  group('показ чисел', () {
    ...
    test('от часа и дольше — ч:мм:сс', () {
      // Барабан длительности больше не упирается в 59:59: колд брю ставят
      // шагом на несколько часов. Без этой ветки двенадцатичасовое
      // замачивание показывалось бы как «720:00».
      expect(formatDuration(3600), '1:00:00');
      expect(formatDuration(3665), '1:01:05');
      expect(formatDuration(12 * 3600), '12:00:00');
      // Ровно на границе часа — уже с часами, секундой раньше — ещё без них.
